...
class EditNewTaskRoute extends StatelessWidget {
  EditNewTaskRoute(
      {Key? key,
  ...
  final GlobalKey<_EditNewTaskState> _myEdit = GlobalKey();
...
class EditNewTask extends StatefulWidget {
  const EditNewTask({Key? key, required this.failTaskGenerators})
      : super(key: key);

  final List<TaskGenerator> failTaskGenerators;

  @override
  State<StatefulWidget> createState() => _EditNewTaskState();
}
